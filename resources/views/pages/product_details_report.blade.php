          ...
          {{-- <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-center"><h3>Product Name:{{$product->product_title}}</h3></div>
                </div>
            </div>
          </div>
        </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-center"><h3>প্রোডাক্ট ক্রয়</h3></div>
